...
public class DesignToolbar extends Toolbar {
  ...
  public DesignToolbar() {
    ...
    languageItems.add(new DropDownItem(WIDGET_NAME_SWITCH_LANGUAGE_GERMAN,
        MESSAGES.switchLanguageGermanButton(), new SwitchLanguageToGermanAction()));
    languageItems.add(new DropDownItem(WIDGET_NAME_SWITCH_LANGUAGE_VIETNAMESE,
        MESSAGES.switchLanguageVietnameseButton(), new SwitchLanguageToVietnameseAction()));
  ...
  private class SwitchLanguageToGermanAction implements Command {
    @Override
    public void execute() {
      switchLanguage("de");
    }
  ...
  private class SwitchLanguageToVietnameseAction implements Command {
    @Override
    public void execute() {
      switchLanguage("vi");
    }
