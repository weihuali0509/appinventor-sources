...
public class TranslationDesignerPallete {
  ...
  //     value = MESSAGES.animationComponentPallette();
  ...
  //   } else if (key.equals("Screen Arrangement")) {
  //     value = MESSAGES.screenArrangementComponentPallette();
  //   } else if (key.equals("LEGO\u00AE MINDSTORMS\u00AE")) {
  //     value = MESSAGES.legoComponentPallette();
  //   } else if (key.equals("Other stuff")) {
  //     value = MESSAGES.otherStuffComponentPallette();
